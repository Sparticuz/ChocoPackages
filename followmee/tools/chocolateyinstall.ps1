...
$packageName= 'followmee' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'https://www.followmee.com/download/setup_followmee.exe' # download url
...
$packageArgs = @{
  ...
  softwareName  = 'followmee*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
